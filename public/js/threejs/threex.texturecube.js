...
THREEx.TextureCube.initWellKnownUrls	= function(baseUrl){
	...
	wellKnownUrls['sky1']	= THREEx.TextureCube.createUrls('sky1'	, '.png', rootUrl)
	wellKnownUrls['sky2']	= THREEx.TextureCube.createUrls('sky2'	, '.png', rootUrl)
	wellKnownUrls['sky3']	= THREEx.TextureCube.createUrls('sky3'	, '.png', rootUrl)
	wellKnownUrls['sky4']	= THREEx.TextureCube.createUrls('sky4'	, '.png', rootUrl)
	wellKnownUrls['sky5']	= THREEx.TextureCube.createUrls('sky5'	, '.png', rootUrl)
	wellKnownUrls['sky6']	= THREEx.TextureCube.createUrls('sky6'	, '.png', rootUrl)
	wellKnownUrls['sky7']	= THREEx.TextureCube.createUrls('sky7'	, '.png', rootUrl)
	// copy result
